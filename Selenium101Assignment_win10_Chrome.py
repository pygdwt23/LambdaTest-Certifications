        ...
        # chrome_options = webdriver.ChromeOptions()
            capability = {
	            ...
	            "LT:Options": {
		            ...
		            "build": "Selenium101AssignmentWithWin10Chrome",
		            "project": "Selenium101AssignmentWithWin10Chrome",
		            "name": "Selenium101AssignmentWithWin10Chrome"
	            }
            }
...
class Scenario001(BaseTest):
    ...
    # Step 6 - Validate whether the same text message is displayed in the right-hand panel under the “Your Message:” section.
        ...
        self.driver.get_screenshot_as_file("Win10Chrome_scenario001.png")
...
class Scenario002(BaseTest):
    ...
    # Step 2 - Select the slider “Default value 15” and drag the bar to make it 95 by validating whether the range value shows 95.
        ...
        self.driver.get_screenshot_as_file("Win10Chrome_scenario002.png")
...
class Scenario003(BaseTest):
    ...
    # Step 3 - Assert “Please fill in the fields” error message.
        ...
        print(errorMsg)
        self.driver.get_screenshot_as_file("Win10Chrome_scenario003_a.png")
        time.sleep(5)
    ...
    # Step 5 - From the Country drop-down, select “United States” using the text property.
        ...
        self.driver.get_screenshot_as_file("Win10Chrome_scenario003_b.png")
        ...
        self.driver.get_screenshot_as_file("Win10Chrome_scenario003_c.png")
        time.sleep(5)
    ...
    # Step 7 - Once submitted, validate the success message “Thanks for contacting us, we will get back to you shortly.” on the screen.
        time.sleep(5)
        self.driver.get_screenshot_as_file("Win10Chrome_scenario003_d.png")
