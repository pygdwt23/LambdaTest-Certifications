        ...
        # chrome_options = webdriver.ChromeOptions()
            capability = {
	            ...
	            "LT:Options": {
		            ...
		            "build": "Selenium101AssignmentWithMacOSCatalinaSafari",
		            "project": "Selenium101AssignmentWithMacOSCatalinaSafari",
		            "name": "Selenium101AssignmentWithMacOSCatalinaSafari"
	            }
            }
...
class Scenario003(BaseTest):
    ...
    # Step 3 - Assert “Please fill in the fields” error message.
        ...
        expectedErrorMsg = "Fill out this field"
